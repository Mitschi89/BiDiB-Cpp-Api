...
#define BIDIB_CS_POM_WR_BIT               2 // bit 6,7: standard pom/short mode/xpom/reserved
...
//      RC_BIND                     0 // 2:data, 3:dec_mun[0],4:dec_mun[1],5:dec_mun[2],6:dec_mun[3], 7:dec_mid
//      RC_PING                     1 // 2:interval
#define RC_TID                      2 // 2:cid[0],3:cid[1],4:cid[2],5:cid[3],6:cid[4], 7:sid
//      RC_PING_ONCE_*              4 // 2:data
//      RC_FIND_*                   6 // 2:data, 3:dec_mun[0],4:dec_mun[1],5:dec_mun[2],6:dec_mun[3], 7:dec_mid
